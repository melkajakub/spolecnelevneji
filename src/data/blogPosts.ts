...
- nemá čas nebo chuť porovnávat nabídky na trhu,
- považuje přechod k jinému dodavateli za složitý.

## Automatická prolongace a „speciální" e-mailové nabídky – tichý nepřítel
...
Navíc vám dodavatel může poslat e-mail s „exkluzivní nabídkou na prodloužení". Tyto nabídky ale často nejsou nijak výhodné – jen vypadají lépe než standardní prolongační cena. Ve skutečnosti na volném trhu najdete lepší podmínky.
...
2. **Porovnávejte nabídky.** Před koncem fixace si zjistěte aktuální ceny na trhu – nestačí jen číst e-maily od svého dodavatele.
